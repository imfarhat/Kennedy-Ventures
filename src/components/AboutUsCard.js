    ...
    <>
      <aside className="flex flex-col items-center justify-center group">
        <Image
          ...
          width={208}
          priority
          className="w-52 h-56 bg-primary rounded-tr-[6.5rem] rounded-bl-[6.5rem] group-hover:rounded-tr-none group-hover:rounded-tl-[6.5rem] group-hover:rounded-bl-none group-hover:rounded-br-[6.5rem] transition-all ease-in object-cover"
          alt="Scott Kennedy"
        />
