            ...
            <div className="flex items-center justify-start gap-2 mt-2">
              ...
              <div>
                <Link
                  ...
                  target="_blank"
                  className="bg-white aspect-square rounded-full hover:text-white hover:scale-105 active:scale-100 transition-all duration-200 ease-in hover:bg-[#3273dc] text-[#3273dc] active:bg-opacity-85 border-2 border-transparent hover:border-white flex items-center justify-center"
                >
