  ...
  return (
    <footer className="border-t flex flex-col items-center justify-center">
      <section className="flex items-center justify-center w-full">
        <div className="container px-4 py-6 bg-secondary/5 rounded-md grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 items-center justify-center w-full mx-4 mt-6 md:mt-8">
            ...
            <div className="flex items-center justify-start gap-2 mt-2">
              ...
              <div>
                <Link
                  ...
                  target="_blank"
                  className="bg-white aspect-square rounded-full hover:text-white hover:scale-105 active:scale-100 transition-all duration-200 ease-in hover:bg-blue-700/85 text-muted-foreground active:bg-opacity-85 border-2 border-transparent hover:border-white flex items-center justify-center"
                >
